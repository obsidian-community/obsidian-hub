...
def process_directory(root, dirs, files):
    ...
    with open(moc_file_path, 'w') as output:
        index_content_for_directory(root, dirs, files, output)


def index_content_for_directory(root, dirs, files, output):
