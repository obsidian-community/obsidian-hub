...
![Downloads](https://img.shields.io/badge/downloads-7-573E7A?style=for-the-badge&logo=)
...
- Ribbon Button Height: Height of buttons on side ribbon.
- Ribbon Button Width: Width of buttons on side ribbon.
- Drag Size: Width of buttons on side ribbon.
- Side Handle Thickness: Resize handle thickness.
- Tab Height: Tab Height
- Outline Level Size: Tab Height
- Text Window Length: Size of text window in text editor.
- Enable QE Support: QE Support is normally disabled. This will readd it.
