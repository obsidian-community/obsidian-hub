...
- Use macOS style on Windows: Turn off Windows specific styling. (Requires reload)
- Disable Apple Notes font style: Turn off alternative lowercase 'a' font style. (Desktop)
