...
Plugin ID: `obsidian-image-toolkit`
Links: [GitHub repository](https://github.com/sissilab/obsidian-image-toolkit) or [<button id=HH>Open in Obsidian</button>](obsidian://show-plugin?id=obsidian-image-toolkit)
