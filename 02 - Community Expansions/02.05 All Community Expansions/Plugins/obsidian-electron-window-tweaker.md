...
aliases: [Electron Window Tweaker]
tags: []
publish: true
---
...
Plugin ID: `obsidian-electron-window-tweaker`
Links: [GitHub repository](https://github.com/mgmeyers/obsidian-electron-window-tweaker) or [<button id=HH>Open in Obsidian</button>](obsidian://show-plugin?id=obsidian-electron-window-tweaker)
