...
Plugin ID: `open-vscode`
Links: [GitHub repository](https://github.com/NomarCub/obsidian-open-vscode) or [<button id=HH>Open in Obsidian</button>](obsidian://show-plugin?id=open-vscode)
