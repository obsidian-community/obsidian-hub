...
Plugin ID: `customizable-sidebar`
Links: [GitHub repository](https://github.com/phibr0/obsidian-customizable-sidebar) or [<button id=HH>Open in Obsidian</button>](obsidian://show-plugin?id=customizable-sidebar)
Developed by: [[phibr0]]
