...
Plugin ID: `obsidian-daily-stats`
Links: [GitHub repository](https://github.com/dhruvik7/obsidian-daily-stats) or [<button id=HH>Open in Obsidian</button>](obsidian://show-plugin?id=obsidian-daily-stats)
