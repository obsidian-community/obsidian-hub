...
aliases: [File Explorer Note Count]
tags: []
publish: true
---
...
Plugin ID: `file-explorer-note-count`
Links: [GitHub repository](https://github.com/ozntel/file-explorer-note-count) or [<button id=HH>Open in Obsidian</button>](obsidian://show-plugin?id=file-explorer-note-count)
Developed by: [[ozntel]]
