...
Plugin ID: `oz-clear-unused-images`
Links: [GitHub repository](https://github.com/ozntel/oz-clear-unused-images-obsidian) or [<button id=HH>Open in Obsidian</button>](obsidian://show-plugin?id=oz-clear-unused-images)
Developed by: [[ozntel]]
