...
Plugin ID: `obsidian-auto-link-title`
Links: [GitHub repository](https://github.com/zolrath/obsidian-auto-link-title) or [<button id=HH>Open in Obsidian</button>](obsidian://show-plugin?id=obsidian-auto-link-title)
