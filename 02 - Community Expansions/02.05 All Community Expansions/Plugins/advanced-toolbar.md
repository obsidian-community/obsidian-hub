...
aliases: [Advanced Mobile Toolbar]
tags: []
publish: true
---
...
Plugin ID: `advanced-toolbar`
Links: [GitHub repository](https://github.com/phibr0/obsidian-advanced-toolbar) or [<button id=HH>Open in Obsidian</button>](obsidian://show-plugin?id=advanced-toolbar)
Developed by: [[phibr0]]
