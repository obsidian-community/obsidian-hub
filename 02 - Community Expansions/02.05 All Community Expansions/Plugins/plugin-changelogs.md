...
Plugin ID: `plugin-changelogs`
Links: [GitHub repository](https://github.com/phibr0/obsidian-plugin-changelogs) or [<button id=HH>Open in Obsidian</button>](obsidian://show-plugin?id=plugin-changelogs)
Developed by: [[phibr0]]
