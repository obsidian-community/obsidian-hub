...
Plugin ID: `editor-commands-remap`
Links: [GitHub repository](https://github.com/c4ctus5/editor-commands-remap) or [<button id=HH>Open in Obsidian</button>](obsidian://show-plugin?id=editor-commands-remap)
