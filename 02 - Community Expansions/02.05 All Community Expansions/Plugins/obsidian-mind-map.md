...
Plugin ID: `obsidian-mind-map`
Links: [GitHub repository](https://github.com/lynchjames/obsidian-mind-map) or [<button id=HH>Open in Obsidian</button>](obsidian://show-plugin?id=obsidian-mind-map)
