...
- [[companion|Companion]]: A github copilot-like interface for obsidian that can use ChatGPT under the hood.
...
- [[image-ocr|Image OCR]]: Runs ocr on images and pastes result in description.
