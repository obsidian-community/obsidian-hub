...
- [[advanced-word-count|Advanced Word Count]]: Allows you to create complex word count presets that will be displayed in the status bar. Made with academic use cases in mind.
...
- [[agent-console|Agent Console]]: Run multiple ACP-compatible agent sessions in parallel tabs. Connect Kiro CLI, Claude Code, Codex, Gemini CLI, or any custom agent.
...
- [[air-sync|Air Sync]]: Sync your vault with cloud storage (Google Drive, Dropbox).
...
- [[buildian|Buildian]]: Unofficial integration for the xAI Grok Build CLI, based on Claudian.
...
- [[copy-link-button|Copy Link Button]]: Adds a copy button next to markdown links and bare URLs so you can copy the URL with a single click.
...
- [[google-sync|Google Calendar and Tasks Sync]]: Sync your vault's events and tasks folders to Google Calendar and Google Tasks.
...
- [[hledger|Hledger]]: Plain text accounting plugin using hledger.
...
- [[jotdrop|JotDrop]]: Google Keep–style quick-capture card grid. Capture notes on Android via the companion app and see them as cards in your vault. Offline, no account, every note is plain Markdown.
...
- [[large-language-models|Large Language Models]]: Chat with LLMs (OpenAI, Claude, Gemini, Mistral, Ollama, LM Studio) directly in Obsidian. Includes Skills, Projects, Assistants, Memory, vault search, voice transcription, and an Obsidian Agent that can read and write your vault.
...
- [[line-search|Line Search]]: Uses each line as a separate unit for fuzzy and out-of-order word search across all Markdown files in the vault.
...
- [[lonelog|Lonelog]]: Streamline solo TTRPG journaling with Lonelog notation shortcuts and templates.
...
- [[maps-of-content|Maps of Content]]: Dynamically generate Maps of Content (MOC) by extracting matching list items from notes in your vault.
...
- [[markdown-wechat-publisher|Markdown WeChat Publisher]]: Preview, style, copy, and publish Markdown notes to multiple WeChat Official Accounts.
...
- [[memmaster|MemMaster Flashcards]]: Create flashcards from notes and study with spaced repetition, active recall, review scheduling, memory retention, and study reminders.
...
- [[miseflow|MiseFlow]]: Plan your meals, manage your grocery list, and view recipe notes as interactive cards.
...
- [[morning-os|Morning OS]]: Daily briefing dashboard that surfaces tasks, goals, and AI insights from your vault.
...
- [[music-pro|Music Pro]]: A plug-and-play music app for deep work.
...
- [[native-mcp|Native MCP]]: MCP server for AI assistants to read, search, create, and modify notes in your vaults
...
- [[note-database|Note Database]]: Database views for notes with table, board, gallery, formulas, filters, and inline editing.
...
- [[novel-profile|Novel Profile]]: Transforms the native properties area into an elegant character profile card.
...
- [[pandazap|Panda Zap]]: Convert Markdown notes into Anki flashcards and sync locally.
...
- [[publish-as-link|Publish Single Note as Webpage]]: Publish your notes to Alibaba Cloud OSS and share them as a link with one click.
...
- [[quickclip-organize|QuickClip Organize]]: A Portent-based dashboard to classify, connect, and track every note through its lifecycle — from raw capture to organized knowledge. Works with any note; enhanced with the QuickClip extension.
...
- [[randomness|Randomness]]: Random table generator for TTRPG and creative writing. Compatible with the Inspiration Pad Pro 3 (IPP3) syntax. Roll inline, lock results, browse generators in a sidebar.
...
- [[regex-css-highlighter|Regex Css Highlighter]]: Regex matching + CSS highlighting with real-time preview and instant effects.
...
- [[obsync|S3 Vault Sync]]: Sync vault files through OSS / S3-compatible object storage.
...
- [[simple-pinned-files|Simple Pinned Files]]: Pin files for quick access in a simple sidebar view.
...
- [[source-mode-inline-images|Source Mode Inline Images]]: Render image previews below image links in Source mode.
...
- [[starvault|StarVault]]: GitHub starred repositories sync and management tool.
...
- [[table-exporter|Table Exporter]]: Export rendered Markdown tables to PNG, CSV, Excel, and PDF.
...
- [[tag-lens|Tag Lens]]: Lightweight tag-membership visualisations: Icon Gallery, intersection lattice, co-occurrence heatmap, UpSet, BubbleSets.
...
- [[teacher-planner|Teacher Planner]]: Academic year planner for teachers — timetable management, lesson tracking, and weekly planning.
...
- [[vault-reorganizer|Vault Reorganizer]]: Preview and apply bulk vault reorganization plans for notes, attachments, templates, canvases, and other files.
...
- [[vault-task-planner|Vault Task Planner]]: Aggregates all incomplete tasks from the vault into a monthly timeline view with in-place date editing and write-back to source notes.
...
- [[vault-relay|VaultRelay]]: Turn long-form notes into publish-ready content without moving your vault.
...
- [[wechat-article|WeChat Article Composer]]: 基于当前笔记预览公众号样式、生成配图并发布到微信公众号草稿箱.
...
- [[word-reader|Word Reader]]: Open .docx files as safe, read-only documents.
...
- [[feishu-doc-toolbar|ZengQiang Enhanced]]: 浮动工具栏、模板库、原生表格配色与多种内嵌实用工具。需同时安装本仓库 companion-plugins 中的 markdown-table-enhancer。增强表格仅在开启实验性 OneNote 高保真粘贴时后台可用.
...
- [[lilbee|lilbee]]: Search, ask, and chat with your notes, PDFs, and web pages — answers come straight from your own files, with click-to-verify citations (local RAG, done for you). Runs local LLMs, or bring your own from Ollama, LM Studio, OpenAI, Claude, Gemini.
...
- [[rhwp-editor|rHWP Editor]]: Open, create, and edit HWP/HWPX files directly with rhwp.
