...
- [[tars|Tars]]: Text generation based on tag suggestions, using Claude, OpenAI, Kimi, Doubao, Qwen, Zhipu, DeepSeek, QianFan & more.
...
- [[openapi-renderer|OpenAPI Renderer]]: Generates a Swagger-UI interface and embeds it as an iframe
- [[tags-routes|Tags Routes]]: A powerful tool for visualizing 3D graphs and managing orphan files, offering a dynamic and colorful 3D graph view for enhanced user experience.
