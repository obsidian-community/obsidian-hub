...
# for Religious Uses
The Obsidian Community has created plenty of resources for studying religious texts.
...
- Joschua shared how he uses the [[Linking Your Thinking]] framework by Nick Milo to integrate his religious learnings into a PKM system.
...
- [mdbible](https://github.com/lguenth/mdbible) is a JSON-to-[[Markdown]] converter for [Javascripture's online bible](https://javascripture.org/), written by Luke. Currently, only the ESV is provided but he is taking requests for other versions and formats.
