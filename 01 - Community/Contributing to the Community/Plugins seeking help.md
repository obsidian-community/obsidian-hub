...
- [[obsidian-excalidraw-plugin|Excalidraw]] - [BUG: Embedding selected element. Only part of grouped element is shown.](https://github.com/zsviczian/obsidian-excalidraw-plugin/issues/957)
...
- [[dbfolder|Database folder]] - [[FR]: Support DataviewJS as source of the database](https://github.com/RafaelGB/obsidian-db-folder/issues/628)
...
- [[obsidian-meta-bind-plugin|Meta Bind Plugin]] - [Add changes from `0.4.0` to docs](https://github.com/mProjectsCode/obsidian-meta-bind-plugin/issues/50)
- [[obsidian-meta-bind-plugin|Meta Bind Plugin]] - [Add Templates section to docs](https://github.com/mProjectsCode/obsidian-meta-bind-plugin/issues/49)
