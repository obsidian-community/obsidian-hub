...
- [[obsidian-text-format|Text Format]] - [Command ribbon icon on iOS](https://github.com/Benature/obsidian-text-format/issues/81)
...
- [[obsidian-day-planner|Day Planner]] - [Not working on iOS after upgrading](https://github.com/ivan-lednev/obsidian-day-planner/issues/388)
...
- [[obsidian-jtab|jTab Guitar Codeblocks]] - [Can i get the arpeggios with chord?](https://github.com/davfive/obsidian-jtab/issues/11)
...
- [[contextual-note-templating|Contextual note templating]] - [Improove Readme for a beginer perspective](https://github.com/Balibaloo/obsidian-local-template-configuration/issues/6)
- [[copilot|Copilot]] - [Indexing issue in Copilot plugin for vaults](https://github.com/logancyang/obsidian-copilot/issues/359)
...
- [[smart-second-brain|Smart Second Brain]] - [Local models are taking ton of space and I think it should be stated in docs](https://github.com/your-papa/obsidian-Smart2Brain/issues/43)
...
- [[templater-obsidian|Templater]] - [Missing Explanation of " File find TFile: <% tp.file.find_tfile("MyFile").basename %> "](https://github.com/SilentVoid13/Templater/issues/546)
- [[obsidian-memos|Thino]] - [Feature Request: Thino 右键菜单增加【复制】选项](https://github.com/Quorafind/Obsidian-Thino/issues/405)
