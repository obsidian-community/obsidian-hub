...
- [[obsidian-meta-bind-plugin|Meta Bind Plugin]] - [Feature Request: Enable first column as Sunday in Date Picker](https://github.com/mProjectsCode/obsidian-meta-bind-plugin/issues/35)
...
- [[repeat-plugin|Repeat]] - [Use the "Readable line length" to choose whether to center content](https://github.com/prncc/obsidian-repeat-plugin/issues/4)
...
- [[dbfolder|Database folder]] - [[FR]: Link Alias for Select Type Column](https://github.com/RafaelGB/obsidian-db-folder/issues/613)
...
- [[obsidian-jupyter|Jupyter]] - [Add package-lock.json or yarn.lock to version control for reproducible builds](https://github.com/tillahoffmann/obsidian-jupyter/issues/56)
...
- [[omnisearch|Omnisearch]] - [[BUG] Failed to load plugin omnisearch](https://github.com/scambier/obsidian-omnisearch/issues/137)
...
- [[obsidian-projects|Projects]] - [Add tests for UI components ](https://github.com/marcusolsson/obsidian-projects/issues/21)
- [[rss-reader|RSS Reader]] - [Translate into multiple languages](https://github.com/joethei/obsidian-rss/issues/43)
- [[obsidian-rollover-daily-todos|Rollover Daily Todos]] - [Does not work well with the templater plugin](https://github.com/lumoe/obsidian-rollover-daily-todos/issues/63)
...
- [[obsidian-checklist-plugin|Checklist]] - [Proper way to use .css snippets for obsidian-checklist-plugin.](https://github.com/delashum/obsidian-checklist-plugin/issues/162)
