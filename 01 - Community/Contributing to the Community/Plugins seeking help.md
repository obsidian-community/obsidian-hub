...
- [[halo|Halo]] - [推送到halo的标题没有id作为锚点，导致右边文章目录点击不会自动定位](https://github.com/halo-sigs/obsidian-halo/issues/1)
...
- [[khoj|Khoj]] - [Add a health check to Khoj](https://github.com/khoj-ai/khoj/issues/570)
...
- [[longform|Longform]] - [Add hotkey to keep focus on New Scene text input when adding new scene](https://github.com/kevboh/longform/issues/214)
- [[longform|Longform]] - [Enlarge font size in the side pane](https://github.com/kevboh/longform/issues/6)
- [[math-booster|Math Booster]] - [Settings UI improvement](https://github.com/RyotaUshio/obsidian-math-booster/issues/206)
- [[media-extended|Media Extended]] - [Feature: Add Commands for Pip toggle](https://github.com/aidenlx/media-extended/issues/66)
- [[obsidian-meta-bind-plugin|Meta Bind Plugin]] - [[FR] useLinks(partial)](https://github.com/mProjectsCode/obsidian-meta-bind-plugin/issues/151)
- [[obsidian-meta-bind-plugin|Meta Bind Plugin]] - [Option to keep suggester open after input](https://github.com/mProjectsCode/obsidian-meta-bind-plugin/issues/146)
...
- [[remotely-secure|Remotely Secure]] - [[Feature Request]: Receive the notification 'Remotely Secure finish!' after 'Remotely Secure already running in stage...'](https://github.com/sboesen/remotely-sync/issues/41)
- [[remotely-secure|Remotely Secure]] - [[Feature Request]: Security Enhancement - warn users when not encrypting with a password.](https://github.com/sboesen/remotely-sync/issues/39)
- [[remotely-secure|Remotely Secure]] - [[Feature Request]: Security Enhancement - warn users when connecting over HTTP to any sync provider](https://github.com/sboesen/remotely-sync/issues/38)
...
- [[code-styler|Code Styler]] - [Bug: `Display Header Language Tags` setting not work on mobile](https://github.com/mayurankv/Obsidian-Code-Styler/issues/99)
...
- [[excel|Excel]] - [[FR] 单元格识别obsidian的内部连接](https://github.com/ljcoder2015/obsidian-excel/issues/28)
...
- [[obsidian-linter|Linter]] - [Bug: Corrupts YAML](https://github.com/platers/obsidian-linter/issues/958)
- [[obsidian-linter|Linter]] - [Bug: Date Format not working with property type Date & Time](https://github.com/platers/obsidian-linter/issues/944)
- [[obsidian-linter|Linter]] - [Bug encountered when creating a new file and saving to generate properties.](https://github.com/platers/obsidian-linter/issues/924)
...
- [[math-booster|Math Booster]] - [Settings UI improvement](https://github.com/RyotaUshio/obsidian-math-booster/issues/206)
- [[math-booster|Math Booster]] - [Collapsible proof env in Reading View](https://github.com/RyotaUshio/obsidian-math-booster/issues/138)
...
- [[obsidian-columns|Obsidian Columns]] - [[FR] Manipulate Columns in CodeBlock without touching the source code](https://github.com/tnichols217/obsidian-columns/issues/63)
...
- [[open-gate|Open Gate]] - [Better explanation for manual icons](https://github.com/nguyenvanduocit/obsidian-open-gate/issues/34)
...
- [[open-gate|Open Gate]] - [Support for Local HTML files](https://github.com/nguyenvanduocit/obsidian-open-gate/issues/24)
...
- [[timethings|Time Things]] - [modified externally and merging changes?](https://github.com/DynamicPlayerSector/timethings/issues/3)
...
- [[typst|Typst Renderer]] - [math in titles](https://github.com/fenjalien/obsidian-typst/issues/39)
...
- [[modalforms|Modal forms]] - [[Docs] add tips and tricks section to the documentation ](https://github.com/danielo515/obsidian-modal-form/issues/145)
- [[modalforms|Modal forms]] - [[DOCS] Advanced examples](https://github.com/danielo515/obsidian-modal-form/issues/110)
- [[modalforms|Modal forms]] - [Link the docs in the settings](https://github.com/danielo515/obsidian-modal-form/issues/58)
...
- [[templater-obsidian|Templater]] - [Missing Explanation of " File find TFile: <% tp.file.find_tfile("MyFile").basename %> "](https://github.com/SilentVoid13/Templater/issues/546)
- [[terminal|Terminal]] - [Obsidian shortcuts dont work when focused in integrated Terminal](https://github.com/polyipseity/obsidian-terminal/issues/33)
