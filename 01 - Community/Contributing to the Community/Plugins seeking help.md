...
- [[text-extractor|Text Extractor]] - [[Feature request] Create the extracted text file in a designated folder, not in the vault root](https://github.com/scambier/obsidian-text-extractor/issues/3)
