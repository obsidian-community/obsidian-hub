...
- [[obsidian-bible-reference|Bible Reference]] - [Conflict with icon shortcodes](https://github.com/tim-hub/obsidian-bible-reference/issues/11)
...
- [[obsidian-excalidraw-plugin|Excalidraw]] - [inserted picture not visible (only shows link)](https://github.com/zsviczian/obsidian-excalidraw-plugin/issues/697)
...
- [[obsidian-kanban|Kanban]] - [[Feature]: option to turn off card counter in list title](https://github.com/mgmeyers/obsidian-kanban/issues/523)
...
- [[obsidian-git|Obsidian Git]] - [Enhancement request: Icon order in source control view](https://github.com/denolehov/obsidian-git/issues/259)
...
- [[obsidian-tasks-plugin|Tasks]] - [Checkboxes should have more prominent style](https://github.com/obsidian-tasks-group/obsidian-tasks/issues/2)
...
- [[obsidian-bible-reference|Bible Reference]] - [Add German Bible translation](https://github.com/tim-hub/obsidian-bible-reference/issues/35)
- [[obsidian-bible-reference|Bible Reference]] - [Adding more scripture API](https://github.com/tim-hub/obsidian-bible-reference/issues/33)
...
- [[dbfolder|Database folder]] - [[FR] Option to resize columns](https://github.com/RafaelGB/obsidian-db-folder/issues/50)
...
- [[dbfolder|Database folder]] - [Refactor of data dispatch to not render all the table cells](https://github.com/RafaelGB/obsidian-db-folder/issues/37)
...
- [[obsidian-mkdocs-publisher|Github Publisher]] - [[FR] Publisher modal](https://github.com/obsidianMkdocs/obsidian-github-publisher/issues/1)
...
- [[obsidian-import-json|JSON/CSV Importer]] - [Empty folders, no notes](https://github.com/farling42/obsidian-import-json/issues/15)
...
- [[obsidian-icon-folder|Obsidian Icon Folder]] - [Plugin causes search malfunction as of insider release 0.15](https://github.com/FlorianWoelki/obsidian-icon-folder/issues/79)
...
- [[obsidian-tasks-plugin|Tasks]] - [Tasks should work inside admonitions](https://github.com/obsidian-tasks-group/obsidian-tasks/issues/563)
- [[obsidian-tasks-plugin|Tasks]] - [Priority UI Dropdown on task create should allow selection by typing](https://github.com/obsidian-tasks-group/obsidian-tasks/issues/547)
- [[obsidian-tasks-plugin|Tasks]] - [The cursor is placed before the task when creating a new task using the modal](https://github.com/obsidian-tasks-group/obsidian-tasks/issues/525)
- [[obsidian-tasks-plugin|Tasks]] - [Update documentation to clarify ban of multi-line checklist items (if they are tasks)](https://github.com/obsidian-tasks-group/obsidian-tasks/issues/469)
- [[obsidian-tasks-plugin|Tasks]] - [Triggering "Toggle task done" on an empty line does not move the cursor to the end of the line](https://github.com/obsidian-tasks-group/obsidian-tasks/issues/460)
...
- [[obsidian-tasks-plugin|Tasks]] - [README should link to helpful tools](https://github.com/obsidian-tasks-group/obsidian-tasks/issues/201)
- [[obsidian-tasks-plugin|Tasks]] - [There should be an option to put the global filter at the end](https://github.com/obsidian-tasks-group/obsidian-tasks/issues/147)
- [[obsidian-tasks-plugin|Tasks]] - [Show open tasks badge](https://github.com/obsidian-tasks-group/obsidian-tasks/issues/140)
- [[obsidian-tasks-plugin|Tasks]] - [Checkboxes should have more prominent style](https://github.com/obsidian-tasks-group/obsidian-tasks/issues/2)
...
- [[obsidian-checklist-plugin|Checklist]] - [Please Add Tutorial on Glob Pattern to Obsidian Plugin Page](https://github.com/delashum/obsidian-checklist-plugin/issues/120)
...
- [[dataview|Dataview]] - [A way to ignore tasks under a section](https://github.com/blacksmithgu/obsidian-dataview/issues/1168)
