...
- [[typing-transformer-obsidian|Typing Transformer]] - [[HELP] Line numbers markers is not aligned with the rule content if reopen the settings tab](https://github.com/aptend/typing-transformer-obsidian/issues/27)
