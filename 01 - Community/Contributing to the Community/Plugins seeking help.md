...
- [[obsidian-excalidraw-plugin|Excalidraw]] - [Block reference parts image is not shown in the page](https://github.com/zsviczian/obsidian-excalidraw-plugin/issues/788)
...
- [[dbfolder|Database folder]] - [[FR] Option to hide the top bar + bottom bar (the new row/file)](https://github.com/RafaelGB/obsidian-db-folder/issues/359)
...
- [[rss-reader|RSS Reader]] - [Translate into multiple languages](https://github.com/joethei/obsidian-rss/issues/43)
- [[obsidian-sidebar-toggler|Sidebar Toggler]] - [Roadmap: Title Editing for Popout Windows](https://github.com/chrisgrieser/obsidian-sidebar-toggler/issues/1)
- [[simple-embeds|Simple Embeds]] - [`Error: [CM6][simple-embeds] Using a deprecated package: "@codemirror/rangeset"`](https://github.com/samwarnick/obsidian-simple-embeds/issues/45)
...
- [[todoist-completed-tasks-plugin|Todoist completed tasks]] - [Update docs](https://github.com/Ledaryy/obsidian-todoist-completed-tasks/issues/5)
