...
- [[omnisearch|Omnisearch]] - [[Feature request] Show error when attempting to create page with an invalid character](https://github.com/scambier/obsidian-omnisearch/issues/52)
